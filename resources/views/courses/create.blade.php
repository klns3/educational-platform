@php
    $labels = [
        ...
        'save' => 'Создать курс',
        'back' => 'Назад',
        'heading' => 'Создание курса',
        'subtitle' => 'Заполните основные данные курса и добавьте обложку.',
        'cover_hint' => 'JPG, PNG, WEBP. До 4 МБ.',
    ];
@endphp
                    ...
                    <div class="grid gap-6 p-6">
                        ...
                        <div class="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-5 dark:border-white/10 dark:bg-white/[0.03]">
                            <div class="mb-4 flex items-center justify-between gap-4">
                                ...
                                <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-xl dark:bg-blue-500/15">
                                    🖼
                                </div>
                            </div>
                            ...
                            <input type="file"
                                   ...
                                   class="block w-full rounded-[1.4rem] border border-dashed border-slate-300 bg-white px-4 py-4 text-sm font-bold text-slate-500 file:mr-4 file:rounded-xl file:border-0 file:bg-blue-600 file:px-4 file:py-2 file:text-sm file:font-black file:text-white hover:border-blue-400 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-300">
